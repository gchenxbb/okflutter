 ...
 * 电池电量
 */
public class BatteryLevelEventPlugin implements MethodChannel.MethodCallHandler {
    ...
    private BatteryLevelEventPlugin(Context context) {
        this.context = context;
    }

    public static void registerWith(Context context, BinaryMessenger messenger) {
        channel = new MethodChannel(messenger, CHANNEL);
        channel.setMethodCallHandler(new BatteryLevelEventPlugin(context));
    }
